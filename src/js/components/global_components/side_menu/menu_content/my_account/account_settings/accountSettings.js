...
const AccountSettings = (props) => {
  ...
  return (
    <div className={styles.accountSettings}>
      <p className={styles.title} onClick={props.toggleAccountSettings}>
        {t("Account settings")}
      </p>
      ...
      <ul
        className={`${styles.settings} ${props.showAccountSettings && styles.showSettings}`}
      >
        <li>
          <p onClick={props.openNewNameModal}>{t("Change name")}</p>
        </li>
        <li>
          <p onClick={props.openNewPasswordModal}>{t("Change password")}</p>
        </li>
        <li>
          <p onClick={props.openProfileImageModal}>
