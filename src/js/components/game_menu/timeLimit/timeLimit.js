...
const timeLimit = (props) => {
    ...
    const defaultTime = moment.duration(props.timeLimit, 'seconds').format(TIME_FORMAT, { trim: false });
    ...
    return (
        <div className={styles.timeLimit}>
            <div className={styles.wrapper}>
                <Switch onClick={toggleTimePicker} checked={props.showTimePicker}></Switch>
